...
IMG_FOLDER_PATH = '/home/rohit/Desktop/rug/MIO-TCD-Localization/train/'
IMG_EXTN = '.jpg'
...
def start():
    ...
    tcg = tcg.loc[tcg['class_name'].isin(['bicycle','pedestrian'])]
    ...
    tcg.to_csv('train_data_bp.txt',index=False,header=False)
