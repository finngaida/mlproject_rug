...
#SBATCH --gres=gpu:1
#SBATCH --mem=8GB
#SBATCH --job-name="vgg,0.4,Test retinanet 1 gpu vgg16 backbone"
...
python keras_retinanet/bin/evaluate.py --backbone vgg16 --convert-model --iou-threshold 0.4 --config vgg16_config.ini csv test_data_final.txt class.csv snapshots/vgg16_csv_29.h5 | tee retinanet_test_logs_vgg16_gpu.txt
