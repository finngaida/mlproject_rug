...
#SBATCH --gres=gpu:1
#SBATCH --mem=8GB
#SBATCH --job-name="Train retinanet 1 gpu resnet50 backbone, from epochs 38"
...
python keras_retinanet/bin/train.py --weights snapshots/resnet50_csv_38.h5 --freeze-backbone --backbone resnet50 --epochs 12 --tensorboard-dir ./logs_resnet50 csv train_data_bp.csv class.csv 
