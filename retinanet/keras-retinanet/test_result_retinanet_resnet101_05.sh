...
#SBATCH --gres=gpu:1
#SBATCH --mem=8GB
#SBATCH --job-name="101,0.5,Test retinanet 1 gpu resnet101 backbone"
...
python keras_retinanet/bin/evaluate.py --backbone resnet101 --convert-model --config resnet101_config.ini csv test_data_final.txt class.csv snapshots/resnet101_csv_33.h5 | tee retinanet_test_logs_resnet101_gpu_05.txt
