...
#SBATCH --gres=gpu:1
#SBATCH --mem=8GB
#SBATCH --job-name="Test retinanet 1 gpu resnet50 backbone"
...
python keras_retinanet/bin/evaluate.py --backbone resnet50 --convert-model --config resnet50_config.ini csv test_data_final.txt class.csv snapshots/resnet50_csv_12.h5 | tee retinanet_test_logs_resnet50_gpu.txt
