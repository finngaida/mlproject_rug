...
#SBATCH --gres=gpu:1
#SBATCH --mem=8GB
#SBATCH --job-name="resnet101 Train retinanet 1 gpu resnet101 backbone"
...
python keras_retinanet/bin/train.py  --freeze-backbone --backbone resnet101  --tensorboard-dir ./logs_resnet101 csv train_data_bp.csv class.csv 
